...
- A release is not complete until APK/AAB build, hash, public R2 readback, GitHub release, one selected registered OnePlus phone, same-phone reversible expanded-layout, same-package upgrade persistence, and authenticated sync have been verified. The selected phone must be identified by hardware serial and pass the exact signed artifact; a second phone and emulators are supplemental.
